...
export default function SubcategoryCard({ title, index }: SubcategoryCardProps) {
  return (
    <motion.button
      ...
      className="w-full bg-white border border-gray-200 rounded-xl px-5 py-4 flex items-center justify-between group hover:border-blue-400 hover:shadow-sm transition-all duration-200 text-left active:scale-[0.98]"
    >
